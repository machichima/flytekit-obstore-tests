...
# Remote path
remote_path_from = "gs://flyte-gcs-bucket-nary/test.json"
remote_path_to = "gs://flyte-gcs-bucket-nary/test_new.json"
...
if __name__ == "__main__":
    ...
    result = runner.invoke(
        ...
        [
            "--config",
            "/home/nary/workData/opensource-projects/flyte/config-sandbox-gcs.yaml",
            "run",
            path,
            "wf",
        ],
